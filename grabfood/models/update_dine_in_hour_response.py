...
class UpdateDineInHourResponse(BaseModel):
    """
    Object contain update store dine-in hour response
    """ # noqa: E501
    error_reasons: Optional[List[StrictStr]] = Field(default=None, description="Error message when updating store dine-in hour. `null` indicates no error.", alias="errorReasons")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["errorReasons"]
