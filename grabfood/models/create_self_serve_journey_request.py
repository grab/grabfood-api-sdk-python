...
class CreateSelfServeJourneyRequest(BaseModel):
    """
    
    """ # noqa: E501
    partner: CreateSelfServeJourneyRequestPartner
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["partner"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "partner": CreateSelfServeJourneyRequestPartner.from_dict(obj["partner"]) if obj.get("partner") is not None else None
        })
