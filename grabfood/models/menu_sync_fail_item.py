...
class MenuSyncFailItem(BaseModel):
    """
    MenuSyncFailItem
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="The item's ID in the partner system. ")
    errors: Optional[List[StrictStr]] = Field(default=None, description="An array of strings of error message.")
    modifier_groups: Optional[List[MenuSyncFailModifierGroup]] = Field(default=None, alias="modifierGroups")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "errors", "modifierGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modifierGroups": [MenuSyncFailModifierGroup.from_dict(_item) for _item in obj["modifierGroups"]] if obj.get("modifierGroups") is not None else None
        })
