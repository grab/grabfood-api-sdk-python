...
class MarkOrderRequest(BaseModel):
    """
    ...
    mark_status: StrictInt = Field(description="The status to be marked accordingly.  * `1` - mark order as ready  * `2` - mark order as completed and only applicable to **dine-in** orders ", alias="markStatus")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["orderID", "markStatus"]

    @field_validator('mark_status')
    def mark_status_validate_enum(cls, value):
        """Validates the enum"""
