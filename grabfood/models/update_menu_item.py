...
class UpdateMenuItem(BaseModel):
    ...
    id: StrictStr = Field(description="The record's ID on the partner system. For example, the item id in case type is ITEM.")
    ...
    __properties: ClassVar[List[str]] = ["merchantID", "field", "id", "price", "availableStatus", "maxStock", "advancedPricings", "purchasabilities"]
