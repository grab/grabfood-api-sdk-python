...
class NewOrderTimeRequest(BaseModel):
    """
    ...
    new_order_ready_time: datetime = Field(description="The new order ready time for this order, based on ISO_8601/RFC3339.", alias="newOrderReadyTime")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["orderID", "newOrderReadyTime"]
