...
class EditOrderV2Response(BaseModel):
    """
    
    """ # noqa: E501
    order_id: Optional[StrictStr] = Field(default=None, description="The order's ID that is returned from GrabFood. Refer to FAQs for more details about [orderID and shortOrderNumber](#section/Order/What's-the-difference-between-orderID-and-shortOrderNumber).", alias="orderID")
    short_order_number: Optional[StrictStr] = Field(default=None, description="The GrabFood short order number. This is unique for each merchant per day. Refer to FAQs for more details about [orderID and shortOrderNumber](#section/Order/What's-the-difference-between-orderID-and-shortOrderNumber).", alias="shortOrderNumber")
    ...
    payment_type: Optional[StrictStr] = Field(default=None, description="The payment method used. Refer to FAQs for more details about [paymentType](#section/Order/Does-the-paymentType-affect-partners).", alias="paymentType")
    cutlery: Optional[StrictBool] = Field(default=None, description="The boolean value to indicate whether cutlery are needed or not. Refer to FAQs for more details about [cutlery](#section/Order/What-do-the-true-or-false-values-mean-for-cutlery).")
    order_time: Optional[StrictStr] = Field(default=None, description="The UTC time that a consumer places the order, based on ISO_8601/RFC3339.", alias="orderTime")
    submit_time: Optional[datetime] = Field(default=None, description="The order submit time, based on ISO_8601/RFC3339. `null` in EditOrder V2 response. Only present in the [List Orders](#tag/list-order) response.", alias="submitTime")
    complete_time: Optional[datetime] = Field(default=None, description="The order complete time, based on ISO_8601/RFC3339. `null` in EditOrder V2 response. Only present in the [List Orders](#tag/list-order) response.", alias="completeTime")
    ...
    order_state: Optional[StrictStr] = Field(default=None, description="The state of the order. Empty in EditOrder V2 response. Only present in the [List Orders](#tag/list-order) response. Refer to [Order States](#section/Order-states).", alias="orderState")
    currency: Optional[Currency] = None
    feature_flags: Optional[OrderFeatureFlags] = Field(default=None, alias="featureFlags")
    items: Optional[List[OrderItem]] = Field(default=None, description="The ordered items in an array of JSON Object. ")
    ...
    receiver: Optional[Dict[str, Any]] = Field(default=None, description="This field is set to `null` in the EditOrder V2 response. Refer to the [Submit Order](#tag/submit-order-webhook/operation/submit-order-webhook) payload for the complete receiver information.")
    ...
    payments: Optional[List[StrictStr]] = Field(default=None, description="This field is set to `null` in the EditOrder V2 response. Refer to the [Submit Order](#tag/submit-order-webhook/operation/submit-order-webhook) payload for the complete payment details.")
