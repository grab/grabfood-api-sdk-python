...
class DineIn(BaseModel):
    ...
    """ # noqa: E501
    table_id: Optional[StrictStr] = Field(default=None, description="Table number.", alias="tableID")
    eater_count: Optional[StrictInt] = Field(default=None, description="The number of eaters.", alias="eaterCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tableID", "eaterCount"]
