...
class MenuSyncFail(BaseModel):
    """
    MenuSyncFail
    """ # noqa: E501
    id: Optional[StrictStr] = None
    errors: Optional[List[StrictStr]] = Field(default=None, description="An array of strings of error message.")
    service_hours: Optional[MenuSyncFailServiceHours] = Field(default=None, alias="serviceHours")
    categories: Optional[List[MenuSyncFailCategory]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "errors", "serviceHours", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceHours": MenuSyncFailServiceHours.from_dict(obj["serviceHours"]) if obj.get("serviceHours") is not None else None,
            "categories": [MenuSyncFailCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
