...
class MenuSyncFailModifierGroup(BaseModel):
    """
    ...
    modifiers: Optional[List[MenuSyncFailModifier]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "errors", "modifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modifiers": [MenuSyncFailModifier.from_dict(_item) for _item in obj["modifiers"]] if obj.get("modifiers") is not None else None
        })
