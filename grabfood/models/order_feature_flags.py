...
class OrderFeatureFlags(BaseModel):
    """
    ...
    @field_validator('order_accepted_type')
    def order_accepted_type_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderAcceptedType": obj.get("orderAcceptedType"),
            "orderType": obj.get("orderType"),
            "isMexEditOrder": obj.get("isMexEditOrder")
        })
