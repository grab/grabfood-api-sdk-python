...
class RedeemDineInVoucherRequest(BaseModel):
    """
    Dine in voucher redemption 
    """ # noqa: E501
    certificate_id: StrictStr = Field(description="This certificateID is decoded from scanning the QR code, and 1:1 mapping with `voucherCode`.", alias="certificateID")
    merchant_id: StrictStr = Field(description="The merchant's ID that is in GrabFood's database.", alias="merchantID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["certificateID", "merchantID"]
