...
class BindMembershipNativeRequest(BaseModel):
    """
    ...
    phone_number: Optional[StrictStr] = Field(default=None, description="Grab user phone number used to login.", alias="phoneNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["grabID", "phoneNumber"]
