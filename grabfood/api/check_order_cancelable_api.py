...
class CheckOrderCancelableApi:
    ...
    def check_order_cancelable(
        ...
        _param = self._check_order_cancelable_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CheckOrderCancelableResponse",
        }
    ...
    @validate_call
    def check_order_cancelable_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        order_id: StrictStr,
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckOrderCancelableResponse]:
        """Check order cancelable
    ...
    @validate_call
    def check_order_cancelable_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        order_id: StrictStr,
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
    ...
    def _check_order_cancelable_serialize(
        self,
        authorization,
        order_id,
        merchant_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/partner/v1/order/cancelable',
