...
class GetStoreStatusApi:
    ...
    def get_store_status(
        ...
        _param = self._get_store_status_serialize(
    ...
    @validate_call
    def get_store_status_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_store_status_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    def _get_store_status_serialize(
        self,
        authorization,
        merchant_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/partner/v1/merchants/{merchantID}/store/status',
