...
class TraceMenuSyncApi:
    ...
    def trace_menu_sync(
        ...
        _param = self._trace_menu_sync_serialize(
    ...
    @validate_call
    def trace_menu_sync_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    @validate_call
    def trace_menu_sync_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    def _trace_menu_sync_serialize(
        self,
        authorization,
        merchant_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/partner/v1/merchant/menu/trace',
