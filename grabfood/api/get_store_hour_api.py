...
class GetStoreHourApi:
    ...
    def get_store_hour(
        ...
        _param = self._get_store_hour_serialize(
    ...
    @validate_call
    def get_store_hour_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_store_hour_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Specify the generated authorization token of the bearer type.")],
        merchant_id: Annotated[StrictStr, Field(description="The merchant's ID that is in GrabFood's database.")],
        _request_timeout: Union[
    ...
    def _get_store_hour_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/partner/v2/merchants/{merchantID}/store/hours',
